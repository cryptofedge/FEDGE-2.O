...
🎵 MUSIC & ENTERTAINMENT: music-industry-manager, music-manager-pro, spotify-for-artists, distrokid, suno-ai, elevenlabs, voice-message, capcut, heygen-ai, higgsfield-ai, creatify-ai

📱 SOCIAL & MARKETING: simplified-social-media, social-media-scheduler, genviral-social-media, tiktok-ads, meta-ads, google-ads, influencer-marketing, hyperframes, canva, linktree, pr-press-outreach, klaviyo, google-analytics

🛍️ BUSINESS & ECOM: shopify, shopify-ad-apps, business, business-plan, business-model-canvas, proposal-writer, event-management, fiverr, sensual-makeup, wix, notion, slack, discord, calendar-manager

⚖️ LEGAL & GRANTS: legal-ai-counsel, ai-legal-standard-v2, normieclaw-legal-docs-pro, rocket-lawyer, grant, grant-writing-framework, nyc-funds-finder

🤖 AI TOOLS: image-generation, gamma-ai, openai-api, claude-code, claude-cowork, claude-design, api-gateway, summarize, document-reader, ai-podcast-creation
...
🔒 SECURITY & DEV: cybersecurity, github, gh-issues, mcp-builder, pdf-reading, file-reading, humanizer, internal-comms, doc-coauthoring, rollhub-analyst, weather, tiktok-ads, product-self-knowledge
